<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="isShopShow = true">
    ...
    <div class="shop-header-discounts" @click="isActivityShow = true" v-if="shopInfo.supports">
      <div class="discounts-left">
        <div class="activity" :class="supportClasses[shopInfo.supports[0].type]">
          <span class="content-tag">
            <span class="mini-tag">{{shopInfo.supports[0].name}}</span>
          </span>
          <span class="activity-content">{{shopInfo.supports[0].content}}</span>
        </div>
      </div>
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="isShopShow">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="isShopShow = false">
    ...
    <transition name="move">
      <div class="activity-sheet" v-show="isActivityShow">
        <div class="activity-sheet-content">
          ...
          优惠活动</h2>
          <ul class="list">
            <li class="activity-item" v-for="support,index in shopInfo.supports" :class="supportClasses[support.type]">
              <span class="content-tag">
          ...
          <div class="activity-sheet-close" @click="isActivityShow=false">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
